...
class ChineseHolidayParser(BaseHolidayParser):
    def __init__(self):
        ...
        self.__fixed_holiday_dictionary = dict([
            ...
            ('元旦', ChineseHolidayParser.new_year),
            ('元旦節', ChineseHolidayParser.new_year),
            ('教師節', ChineseHolidayParser.teacher_day),
            ('青年節', ChineseHolidayParser.youth_day),
            ('兒童節', ChineseHolidayParser.children_day),
            ('婦女節', ChineseHolidayParser.female_day),
            ('植樹節', ChineseHolidayParser.tree_plant_day),
            ('情人節', ChineseHolidayParser.lover_day),
            ('平安夜', ChineseHolidayParser.christmas_eve),
            ('聖誕節', ChineseHolidayParser.christmas_day),
            ('新年', ChineseHolidayParser.new_year),
            ('愚人節', ChineseHolidayParser.fool_day),
            ('五一', ChineseHolidayParser.labor_day),
            ('勞動節', ChineseHolidayParser.labor_day),
            ('萬聖節', ChineseHolidayParser.halloween_day),
            ('中秋節', ChineseHolidayParser.midautumn_day),
            ('中秋', ChineseHolidayParser.midautumn_day),
            ('春節', ChineseHolidayParser.spring_day),
            ('除夕', ChineseHolidayParser.new_year_eve),
            ('元宵節', ChineseHolidayParser.lantern_day),
            ('清明節', ChineseHolidayParser.qing_ming_day),
            ('清明', ChineseHolidayParser.qing_ming_day),
            ('端午節', ChineseHolidayParser.dragon_boat_day),
            ('端午', ChineseHolidayParser.dragon_boat_day),
            ('國慶節', ChineseHolidayParser.chs_national_day),
            ('建軍節', ChineseHolidayParser.chs_mil_build_day),
            ('女生節', ChineseHolidayParser.girls_day),
            ('光棍節', ChineseHolidayParser.singles_day),
            ('雙十一', ChineseHolidayParser.singles_day),
            ('重陽節', ChineseHolidayParser.chong_yang_day),
        ])
