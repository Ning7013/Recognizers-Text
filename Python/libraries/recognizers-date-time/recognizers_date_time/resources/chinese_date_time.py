...
class ChineseDateTime:
    ...
    DatePeriodTillSuffixRequiredRegex = f'(?<till>[与與]|和)'
    ...
    YearToYear = f'({DateRangePrepositions})({DatePeriodYearInCJKRegex}|{YearRegex})\\s*({DatePeriodTillRegex}|后|後|之后|之後)\\s*({DatePeriodYearInCJKRegex}|{YearRegex})(\\s*((之[间間]|之内|期[间間]|中[间間]|间|間)|前|之前))?'
    YearToYearSuffixRequired = f'({DateRangePrepositions})({DatePeriodYearInCJKRegex}|{YearRegex})\\s*({DatePeriodTillSuffixRequiredRegex})\\s*({DatePeriodYearInCJKRegex}|{YearRegex})\\s*(之[间間]|之内|期[间間]|中[间間]|间|間)'
    MonthToMonth = f'({DateRangePrepositions})({MonthRegex}){DatePeriodTillRegex}({MonthRegex})'
    MonthToMonthSuffixRequired = f'({DateRangePrepositions})({MonthRegex}){DatePeriodTillSuffixRequiredRegex}({MonthRegex})\\s*(之[间間]|之内|期[間间]|中[間间]|间|間)'
    DayToDay = f'^[.]'
    DayRegexForPeriod = f'^[.]'
